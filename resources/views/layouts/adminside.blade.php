<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        <ul class="menu-nav">
            <li class="menu-item menu-item{{$menu == 'dashboard' ? '-active': ''}}" aria-haspopup="true">
            ...
            <li class="menu-item menu-item{{$menu == 'users' ? '-active': ''}}" aria-haspopup="true">
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true">
                <a href="index.html" class="menu-link">
                    ...
                    <span class="menu-text">AI Clicker Job</span>
                </a>
            </li>
            <li class="menu-item menu-item-submenu" aria-haspopup="true">
                <a href="index.html" class="menu-link">
                    ...
                    <span class="menu-text">Human Clicker Job</span>
                </a>
            </li>
            <li class="menu-item menu-item-submenu" aria-haspopup="true">
                <a href="index.html" class="menu-link">
